...
Les applications web et mobile sont gratuites et accessibles à toutes et à tous. </div>
&nbsp;
...
<div style="text-align: justify"> Le boîtier GPS marche de pair avec l’application, c’est lui et non le téléphone qui enregistre ta position à intervalle régulier, puis transmet les informations à nos serveurs puis à l’application.
Le système de suivi n’a donc aucunement besoin de ton téléphone pour fonctionner, il peut très bien être en mode avion ou éteint pour l’économie de batterie. Il faut bien entendu désactiver le mode avion si tu veux voir ta position sur l'application. L’application peut aussi être utilisée par tes proches pour suivre ton aventure à n'importe quel moment. </div>
...
{{% row  %}} <!-- ligne sans grille en fond -->
{{% column %}}
## <div style="text-align: left"> Nos utilisateurs </div>

<div style="text-align: justify"> Nous travaillons avec les organisateurs d’aventures souhaitant avoir un suivi en temps réel de leurs participants.es. Nous proposons une solution simple pour les aventuriers.ères qui souhaitent être suivis par leurs proches. Et pour celles et ceux au bureau ou sur le canapé - plus communément appelés les Dotwatchers - l'application permet une expérience immersive pour suivre l’évolution des proches dans leurs aventures. </div>
